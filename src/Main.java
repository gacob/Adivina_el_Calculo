...
public class Main {
    final static int MAX_NUMEROS=6;
    final static int NUMERO_OPERANDOS=4;
    final static String PEDIR_NUMERO="Introduce un número (%d restantes):\n";
    final static String PEDIR_RESULTADO="Introduce el número que debe averiguar:";

    final static Scanner sc=new Scanner(System.in);
    static int[] numeros=new int[MAX_NUMEROS]; // Nuestro array de números
    ...
    private static int[] pedimosNumeros() {
